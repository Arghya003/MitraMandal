...
const createPost= async(req,res)=>{
    try{
        ...
        if(!postedBy||!text){
            return res.status(400).json({message:"Posted and Text felids are required"});
        }
...
const getUserPosts = async (req, res) => {
 ...
 export {createPost,getPost,getUserPosts,getFeedPosts,likeUnlikePost,replyToPost,deletePost}